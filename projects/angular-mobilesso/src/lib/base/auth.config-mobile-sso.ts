...
export class AuthConfigMobileSSO {

  /**
   * For MobileSSO : this boolean active or not the autorifresh of the accessToken at its expiration
   */
  ...
  */
  ...
  constructor(json?: Partial<AuthConfigMobileSSO>) {
    if (json) {
